...
export const EyeagleDiff={
    ...
    content:[
        ...
        {iconType:"app_promo",title:"The power of the Circle app",desc:"Stay connected, no matter where you are. The Circle App integrates seamlessly with our fall alert devices. This ensures caregivers and families receive real-time notifications of emergencies or unusual activity."},
