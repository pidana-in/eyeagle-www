...
export const ctaSection = {
  ...
  primaryCta: {
    ...
    href: "https://shop.eyeagle.ai/products/eyeagle-bathroom-safety-package-audit-prevention-kit-installation-app-membership",
  },
  secondaryCta: {
    label: "Book a safety audit",
    href: "https://shop.eyeagle.ai/products/bathroom-audit",
  },
  image1: HelpImage,
