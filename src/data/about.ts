...
export const aboutUsFoundersData = [
  {
    ...
    name: "Ajay Sharma",
    title: "Co-founder",
    experience: "IIT BHU, IIM Ahmedabad",
    photo: AjaySharma,
    speech:
      "“Elder safety isn’t just about preventing accidents; it’s about preserving independence and dignity. At EyEagle, we strive to make every bathroom a safer space, so families can focus on living, not worrying.”",
  },
  {
    id: 2,
    ...
    photo: Abhinav,
    speech:
      "“Our mission is simple: to protect the ones who protected us. With EyEagle, we ensure that every home is equipped with the right tools to keep our loved ones safe in the places where accidents are most likely to happen.”",
  },
  {
    id: 3,
    name: "Gaurav Kumar",
    ...
    photo: Gaurav,
    speech:
      "“Every detail matters when it comes to elder safety. From the precision of our installations to the speed of our response, EyEagle is committed to ensuring that your loved ones are never left vulnerable.”",
  },
  {
    id: 4,
    name: "Vaibhav Saxena",
    ...
    photo: Vaibhav,
    speech:
      "“Safety for the elderly isn’t just a necessity—it’s a right. At EyEagle, we’re not just installing products; we’re creating peace of mind for families, knowing that their loved ones are protected, even in the most challenging situations.”",
  },
];
...
export const coreValuesIntro = {
  title: "Our Values",
  description:
    "We build reliable, affordable elder‑safety solutions for real homes—so families can focus on living, not worrying.",
};
